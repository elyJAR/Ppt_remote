...
4. In the app, set `Desktop Bridge URL` to your PC IP, for example `http://192.168.1.10:8787`.
5. Select the presentation you want to control.
6. Keep this app in foreground and press phone volume buttons:
...
- If your phone cannot reach the bridge, check Windows firewall for inbound port `8787`.
